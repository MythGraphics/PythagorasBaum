...
void main() {
    ...
    vec3 ambientColor  = material_base.ambient;
    vec3 diffuseColor  = material_base.diffuse;
    vec3 specularColor = material_base.specular;
    float shininess    = material_base.shininess;
    ...
    // Fresnel (Glow): 1.0 an den Kanten, 0.0 in der Mitte
